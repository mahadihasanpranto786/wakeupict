<div class="content-wrapper">
    <section class="invoice">
        ...
        <div class="row no-print">
            <div class="col-xs-12">
                <a href="<?php echo base_url(); ?>user/UserView/print_invoice/<?= $invoice_information->i_id ?>" target="_blank" class="btn btn-primary pull-right"><i class="fa fa-print"></i> Print Invoice</a>
