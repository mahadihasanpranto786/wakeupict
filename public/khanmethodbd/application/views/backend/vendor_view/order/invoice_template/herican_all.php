...
<body onload="print()" style="font-family: arial; margin: 0; padding: 0;">
...
<div id="div_print" style="max-width: 1250px; overflow: hidden; margin: 0 auto; width: 100%; height: 100vh; ">
  
  <!--Header section - start-->

  <header style="padding: 0 0; box-sizing: border-box; overflow: hidden;">
    ...
    <div style="width: 40%; float: left;" class="address">
      <address style="font-style: normal; font-size: 12px;text-align: right;">
       <span style="display: block;"><?= $company_address; ?></span>
      </address>
    </div>
  </header>
  ...
  <!-- Order Section - start-->
   ...
   <div style="">
    <table style="margin: 0 0; width: 100%; border: 1px solid black !important; border-collapse: collapse;">
      <tr>
      ...
      <tr>
          ...
          <td colspan="3">
              <div style="overflow: hidden; text-align: center; font-size: 12px; display: flex; align-items: center;">
                  ...
                  <div style="width: 25%;float: left; padding: 10px; box-sizing: border-box;"><img style="max-width: 60px; width: 100%;" src="<?php echo base_url(); ?>assets/products/<?=$row->p_imagepath?>" alt="Image"></div>
                  <div style="width: 50%;float: left; padding: 12px; box-sizing: border-box; overflow: hidden;">
