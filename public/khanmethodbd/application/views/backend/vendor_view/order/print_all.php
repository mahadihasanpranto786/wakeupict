                ...
                <section class="invoice">
                    ...
                    <div class="row invoice-info">
                        ...
                        <div class="col-sm-4 invoice-col">
                            ...
                            <b>Total Cost:</b> <?= $invoice_information->i_totalcost; ?> TK
                        ...
                        <div class="col-xs-6">
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tr>
                                        <th>Total:</th>
                                        <td><?= $invoice_information->i_totalcost; ?></td>
                                    </tr>
                                    <tr>
                                        <th>Advance:</th>
                                    ...
                                    <tr>
                                        <th>Due Payment:</th>
                                        <td><?= $invoice_information->i_totalcost - $invoice_information->i_payment ?></td>
                                    </tr>
                                </table>
                            </div>
                        </div>
