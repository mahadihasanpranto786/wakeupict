                ...
                <div id="color_change" class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="facebook" value="<?= $company_info->facebook; ?>" class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Youtube</label>
                            <input type="text" name="youtube" value="<?= $company_info->youtube; ?>" class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Lindin</label>
                            <input type="text" name="lindin" value="<?= $company_info->lindin; ?>" class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Insta</label>
                            <input type="text" name="insta" value="<?= $company_info->insta; ?>" class="form-control">
                        </div>
                ...
                <div id="color_change" class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="s_footer" required class="textarea" placeholder="Place some text here" style="width: 100%; height: 100px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?= $company_info->s_footer; ?></textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="s_shipping_method1" value="<?= $company_info->s_shipping_method1; ?>" id="s_shipping_method1" class="form-control" placeholder="Enter shipping cost">
                        </div>
...
<script>
    document.getElementById('s_shipping_method1').value = <?= $company_info->s_shipping_method1 ?>
</script>