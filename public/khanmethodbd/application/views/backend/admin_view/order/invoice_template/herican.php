      ...
      <tr>
        <td style="border: 1px solid black; border-collapse: collapse;" colspan="2">
          <address style="padding: 10px;">
            ...
            <span style="display:block; padding: 5px; font-size: 12px; font-style: normal;"><span style="font-weight: 700;">Thana: </span> <?= $invoice_information->i_thana; ?></span>
            <span style="display:block; padding: 5px; font-size: 12px; font-style: normal;"><span style="font-weight: 700;">District: </span> <?= $invoice_information->i_district; ?></span>
