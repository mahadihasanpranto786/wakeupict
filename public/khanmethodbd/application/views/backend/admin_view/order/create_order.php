                        ...
                        <div class="row">
                            <div class="col-xs-6">
                                <div class="form-group">
                                    <label>Name</label>
                                    <input type="text" name="i_name" class="form-control" placeholder="Enter Customer Name" required>
                                </div>
                            </div>
                            <div class="col-xs-6">
                                <div class="form-group">
                                    <label>Mobile Number</label>
                                    <input type="text" name="i_mobile" class="form-control" placeholder="Enter Mobile Number" required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-xs-4">
                                <div class="form-group">
                                    ...
                                    <input value="0" data-validation="number" data-validation-allowing="range[0;100000]" type="text" name="i_discount" class="form-control">
                                </div>
                            </div>
                            <div class="col-xs-4">
                                <div class="form-group">
                                    <label>Payment</label>
                                    <input value="0" data-validation="number" data-validation-allowing="range[0;100000]" type="text" name="i_payment" class="form-control">
                                </div>
                            </div>
                            <div class="col-xs-4">
                                <div class="form-group">
                                    <label>Shipping Cost</label>
                                    <input value="0" data-validation="number" data-validation-allowing="range[0;100000]" type="text" name="i_shipping_cost" class="form-control">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <label>Shipping Address</label>
                            <textarea name="i_address" placeholder="Shipping Address" class="form-control" style="border: 1px solid #dddddd; padding: 10px;" required></textarea>
                        </div>
                    </div>
                    <!-- /.box-body -->
