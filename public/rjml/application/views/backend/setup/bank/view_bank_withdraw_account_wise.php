                 ...
                 <div class="col-md-12">
                     ...
                     <div class="card card-default mt-3">
                         <div class="card-header">
                             ...
                             <h4 class="text-center text-uppercase"><u>Withdraw</u></h4>
                             <br>
                             <div class="row">
                                 <div class="col-sm-6 bg-primary">
                                     <br>
                                     <h4 class="text-center">Main Balance: <?= number_format(($withdrawById->bacc_balance), 2, '.', ',') ?></h4>
                                     <br>
                                 </div>
                                 <!-- /.col -->
                                 <div class="col-sm-6 bg-secondary">
                                     <br>
                                     <h4 class="text-center">Total Credit Balance: <?= number_format(($withdrawById->bacc_credit_balance), 2, '.', ',') ?></h4>
                                     <br>
                                 </div>
                             </div>
                         </div>
                         ...
                         <form role="form" action="" method="post">
                             <div class="card-body">
                                 <div class="row mb-2 text-danger">
                                     <div class="col-sm-6">
                                         <h4 class="font-weight-bold">Account Holder: <?= $withdrawById->bacc_name ?> </h4>
                                     </div>
                                     <div class="col-sm-6">
                                 ...
                                 <div class="row">
                                     ...
                                     <table id="" class="table table-hover table-bordered">
                                         ...
                                         <tbody>
                                             <?php if (!empty($bankWithdraws)) {
                                                    foreach ($bankWithdraws->result() as $withdraws) { ?>
                                                     <tr>
                                                         <td class="align-middle"><?= date("d-m-Y", strtotime($withdraws->bw_date)); ?></td>
                                                         <td class="align-middle"><?= $withdraws->bw_amount ?></td>
                                                         <td class="align-middle"><?= $withdraws->bw_reference ?></td>
                                                         <td class="align-middle"><?= $withdraws->bw_withdraw_by ?></td>
