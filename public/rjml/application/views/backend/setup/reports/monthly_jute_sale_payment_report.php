				...
				<div class="col-md-4">
					<div class="card card-secondary">
						<div class="card-header">
							<div class="row">
								<div class="col-md-8">
									<h3 class="card-title"><i class="fas fa-th"></i> Monthly Received Amount Reports</h3>
								</div>
								<div class="col-md-4">
									<!-- Filter Yearly Data -->
									<form action="<?php echo base_url('monthly_jute_sale_payment_report'); ?>" method="post">
										<div class="row">
											<div class="col-sm-6">
									...
									<table class="table table-bordered table-striped table-hover">
										...
										<tbody>
											...
											while ($month < $end) {
												...
												<td><?php $PaymentAmount = $this->M_jute_report->getMonthlyTotalClientPaymentAmount($alpha_year, $alpha_month);
													if ($PaymentAmount) {
											...
											<tr class="table-warning font-weight-bold">
												<td>TOTAL</td>
												<td><?php echo round($this->M_jute_report->getMonthlyTotalClientPaymentAmountGrandTotal($startYear, $endYear)); ?></td>
											</tr>
										</tbody>
									</table>
								</div>
