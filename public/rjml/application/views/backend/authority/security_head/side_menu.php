		...
		<nav class="mt-2">
			<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
				...
				<li class="nav-item has-treeview <?= active_open('dashboard', $main_nav); ?>">
					<a href="<?php echo base_url('security_head') ?>" class="nav-link <?= active_nav('dashboard', $main_nav); ?>">
				...
				<li class="nav-item has-treeview <?= active_open('entry', $main_nav); ?>">
					<a href="<?php echo base_url('list_jute_entry') ?>" class="nav-link <?= active_nav('entry', $main_nav); ?>">
						<i class="nav-icon fas fa-tachometer-alt"></i>
						<p>
							List Jute Entry
						</p>
