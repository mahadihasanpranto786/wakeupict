 ...
 <div class="content-wrapper">
 	...
 	<section class="content-header">
 		<div class="container-fluid">
 			<div class="row">
 				<div class="col-sm-6">
 					<h1>Add Assorted Cut Deduction</h1>
 				</div>
 				<div class="col-sm-6">
 					<ol class="breadcrumb float-sm-right">
 						...
 						<li class="breadcrumb-item active"><a href="<?php echo base_url('list_assorted_cut_deduction'); ?>">Back to Assorted Cut
 								Deduction Summary</a></li>
 						<li class="breadcrumb-item active">Add Assorted Cut Deduction</li>
 					</ol>
 				</div>
 			</div>
 		</div>
 				...
 				<div class="col-md-12">
 					...
 					<div class="card card-info mt-3">
 						<div class="card-header">
 							<h3 class="card-title"><i class="fa fa-plus-circle"></i> Add Assorted Cut Deduction</h3>
 						</div>
 						<!-- /.card-header -->
 						<!-- form start -->
 						<form role="form" action="<?php echo base_url('insert_assorted_cut_deduction'); ?>" method="post">
 							<div class="card-body">
 								<div class="row mb-2">
 									<div class="col-sm-1">
 									...
 									<div class="col-sm-2">
 										<input type="text" name="kh_ac_d_v_date" id="kh_ac_d_v_date" class="form-control datepicker" style="width: 100px;" placeholder="" value='' required>
 										<input type="hidden" name="kh_ac_d_v_fy_id" class="form-control" id="kh_ac_d_v_fy_id" placeholder="" value=''>
 									</div>
 									<div class="col-sm-9">
 									</div>
 								</div>
 											...
 											<tr>
 												<td>
 													<div class="form-group col-sm-12 ml-0">
 														<select class="form-control select2" style="width:150px;" name="kh_ac_d_v_kh_id[]" id="khamal_id" required>
 												...
 												<td><input type="text" name="kh_ac_d_v_bojha_no[]" class="form-control input-number-minus-allow" placeholder="Enter Bojha No" value='' required></td>
 												<td><input type="text" name="kh_ac_d_v_avg_weight[]" class="form-control input-number-minus-allow" placeholder="Enter Weight" value=''></td>

 												<?php if ($jute_grades) foreach ($jute_grades->result() as $grade) { ?>
 													<td>
 														<input type="hidden" name="kh_ac_d_v_j_g_id[]" value='<?= $grade->j_g_id ?>'>
 														<input type="text" name="kh_ac_d_v_value[]" class="form-control gradeWeight input-number-minus-allow" id="gradeWeight<?= $grade->j_g_id ?>" placeholder="<?= $grade->j_g_title ?>" value=''>
 													</td>
 												<?php } ?>

 												<td><input type="text" name="kh_ac_d_v_total[]" class="form-control" id="total" placeholder="Total Mds" value='' readonly></td>
 												<td><input type="text" name="kh_ac_d_v_comments[]" class="form-control" id="exampleInputEmail1" placeholder="Comments" value=''></td>
 											</tr>
 										</tbody>
 									</table>
 ...
 <script type="text/javascript">
 	...
 	function addInputField(t) {
 		...
 		if (count == limits) {
			 ...
			 <select class='form-control select2edit' id='' style='width:150px;' name='kh_ac_d_v_kh_id[]' required>\n\
			 	<option value = ''>Select Khamal</option>\n\
				 <?php if ($khamals) {
						foreach ($khamals->result() as $khamal) {
							if ($khamal->kh_used == 3) { ?>\n\
				...
				<?php }
					...
					} ?> </select > </div></td>\n\ <td><input type='text' name='kh_ac_d_v_bojha_no[]' class='form-control input-number-minus-allow' placeholder='Enter Bojha' value='' required></td>\n\
					\n\ <td><input type='text' name='kh_ac_d_v_avg_weight[]' class='form-control input-number-minus-allow' placeholder='Avg. Weight' value='' required></td>\n\
                 <?php if ($jute_grades) foreach ($jute_grades->result() as $grade) { ?>\n\ 
					<input type="hidden" name="kh_ac_d_v_j_g_id[]" value='<?= $grade->j_g_id ?>'>\n\
					<td><input type='text' name='kh_ac_d_v_value[]' class='form-control ${dynamic_class_name} input-number-minus-allow' value=''></td>\n\ 
					<?php } ?>\n\
					<td><input type='text' name='kh_ac_d_v_total[]' class='form-control readonly ${total_grade}' value='' required></td>\n\ 
					\n\ <td><input type='text' name='kh_ac_d_v_comments[]' class='form-control' placeholder='Comm' value=''></td>\n\
 	...
 	$(document).ready(function() {
 		...
 		$("#khamal_id").on("change", function() {
 			...
 			$.ajax({
 				type: 'POST',
 				url: "<?php echo base_url('jute/Khamal/getPreviousAssortedCutDeductionValueByKhamalId') ?>",
 				data: {
 					khamal_id: khamal_id
 				},
 				success: function(data) {
