                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active"><a
                                ...
                                Turn list</a></li>
                        <li class="breadcrumb-item active">Add Unassorted Added</li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-info mt-3">
                        <div class="card-header">
                            <h3 class="card-title">Add Unassorted Added</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form role="form" action="<?php echo base_url('insert_unassorted_added'); ?>" method="post">
                            <div class="card-body">
                                        ...
                                        <tbody id="">
                                            <tr>
                                                <input type="hidden" name="ot_id"
                                                    value='<?= $getJuteOutTurnSummary->ot_id ?>'>
                                                <input type="hidden" name="kh_ua_a_s_area"
                                                    value='<?= $getJuteOutTurnSummary->ot_ar_id ?>'>

                                                <td>
                                                    <input type="hidden" name="kh_ua_a_v_en_date" class="form-control"
                                                        placeholder=""
                                                        value='<?= $getJuteOutTurnSummary->ot_en_date ?>'>
                                                    <input type="text" name="" class="form-control" placeholder=""
                                                        value='<?= date('Y-m-d h:i A', strtotime($getJuteOutTurnSummary->ot_en_date)) ?>'
                                                        readonly>
                                                </td>
                                                <input type="hidden" name="kh_ua_a_v_fy_id" class="form-control"
                                                    placeholder="" value='<?= $getJuteOutTurnSummary->ot_fy_id ?>'>
                                                <td><input type="text" name="kh_ua_a_v_ot_lot_no" class="form-control"
                                                        placeholder="Lot No"
                                                        value='<?= $getJuteOutTurnSummary->ot_lot_no ?>' readonly></td>
                                                <td class="table-success">
                                                    <div class="form-group col-sm-12 ml-0">
                                                        <select class="form-control select2" style="width:170px;"
															...
															?>
                                                            <?php
																		if ($getJuteOutTurnSummary->ot_ar_id == 4) {
																			if ($khamal->kh_ar_id == 4) { ?>
                                                            <option value="<?= $khamal->kh_id; ?>">
                                                                <?= $khamal->kh_title; ?></option>
                                                            <?php	}
																		} elseif ($getJuteOutTurnSummary->ot_ar_id == 5) {
                                                ...
                                                <td><input type="text" name="" class="form-control" id="pureValue"
                                                        ...
                                                        value='<?= $getJuteOutTurnSummary->ot_rec_bojha ?>' readonly>
                                                </td>
                                                <td class="table-success"><input type="text"
                                                        name="kh_ua_a_v_ot_rec_bojha_no" id="kh_ua_a_v_bojha_no"
                                                        class="form-control input-number" placeholder="Enter St. Bojha"
                                                        value='' required>
                                                </td>
                                                ...
                                                <td><input type="text" name="kh_ua_a_v_avg" id="ava"
                                                        ...
                                                        value='<?php echo $jpis_ot_mds_after_deduction / $getJuteOutTurnSummary->ot_rec_bojha; ?>'
                                                        readonly></td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <input type="hidden" name="kh_ua_a_v_valueMod[]"
                                                        ...
                                                        value='<?= getOutTurnPer($grade->j_g_id, $getJuteOutTurnSummary->ot_id); ?>'>
                                                ...
                                                <td><input type="text" name="kh_ua_a_v_total"
                                                        ...
                                                        placeholder="Total" value='' readonly></td>
                                                <td><input type="text" name="kh_ua_a_v_comments" class="form-control"
                                                        id="exampleInputEmail1" placeholder="Comments" value=''></td>
                                ...
                                <input type="hidden" name="kh_ua_a_v_ot_id"
                                    value="<?= $getJuteOutTurnSummary->ot_id ?>">
                            </div>
                            <!-- /.card-body -->
...
$(document).ready(function() {
   ...
   var ava = parseFloat($('#ava').val()) || 0;
            ...
            $(".gradeValueMod").each(function() {
                ...
                console.log(e);
                //$(this).val((parseFloat($(this).val()) * netWeight / 100).toFixed(3));
            });
            console.log(gradeWisePersentage);
            var TotalSum = 0;
            $(".gradeValue").each(function() {
                //var e = $(this).val();
                //console.log(gradeWisePersentage.shift());
                //console.log(e);
            ...
            alert("Sorry! You can't add value more than " +
                <?= $getJuteOutTurnSummary->ot_rec_bojha ?>);
            $('#kh_ua_a_v_bojha_no').val('');
