...
<?php
$tittle = "Jute Mill Management System || Login";
...
<body>
    ...
    <![endif]-->
	<section class="fxt-template-animation fxt-template-layout3" data-bg-image="<?php echo base_url('') ?>assets/login/img/figure/jute_mill.jpg">
		<div class="container">
			<div class="row align-items-center">
				<div class="col-lg-6 col-12 fxt-none-991">
					<div class="fxt-header">
						<!-- <div class="fxt-transformY-50 fxt-transition-delay-1">
                            <a href="login-3.html" class="fxt-logo"><img src="<?php echo base_url('') ?>assets/login/img/logo-3.png" alt="Logo"></a>
                        </div> -->
				...
				<div class="col-lg-6 col-12 fxt-bg-color">
					<div class="fxt-content">
						<div class="fxt-form">
							...
							<form method="POST" action="<?php echo base_url('authority/Login/authentication_process') ?>">
								...
								<div class="form-group">
									<div class="fxt-checkbox-area">
										<a href="<?php echo base_url('forgot_password'); ?>" class="switcher-text">Forgot Password</a>
									</div>
								</div>
								<div class="form-group">
