...
class Weight_operator extends CI_Controller
{

	private $main_layout = 'backend/master_layout';
	private $side_menu = 'backend/authority/weight_operator/side_menu';
	private $viewPath = 'backend/authority/weight_operator/';
