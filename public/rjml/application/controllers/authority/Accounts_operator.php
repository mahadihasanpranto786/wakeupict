...
class Accounts_operator extends CI_Controller
{

	private $main_layout = 'backend/master_layout';
	private $side_menu = 'backend/authority/accounts_operator/side_menu';
	private $viewPath = 'backend/authority/accounts_operator/';
