...
class System_administrator extends CI_Controller
{

	private $main_layout = 'backend/master_layout';
	private $side_menu = 'backend/authority/system_administrator/side_menu';
	private $viewPath = 'backend/authority/system_administrator/';
