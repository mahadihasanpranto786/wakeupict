...
class Production_operator extends CI_Controller
{

	private $main_layout = 'backend/master_layout';
	private $side_menu = 'backend/authority/production_operator/side_menu';
	private $viewPath = 'backend/authority/production_operator/';
