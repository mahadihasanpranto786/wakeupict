			...
			<div class="row">
				...
				<div class="col-md-6">
					<div class="card card-info mt-3">
						<div class="card-header">
							<h3 class="card-title"> <i class="fas fa-info-circle"></i> About Jute Area Information</h3>
						</div>
						<div class="card-body">
							<div class="row">
								<div class="col-md-12">
									<table id="" class="table table-bordered table-hover">
										...
										<tbody>
											<tr>
												<td>HD</td>
												<td>HD এর আওতায় প্রযোজ্য মোকাম সমুহের নামঃ তালমা, পুকুরিয়া, টেকেরহাট ও ভাংগা। </td>
											</tr>
											<tr>
												<td>JAAT</td>
												<td>JAAT এর আওতায় প্রযোজ্য মোকাম সমুহের নামঃ জামালপুর, সরিষাবাড়ী, গোপালপুর, পিগমা, ইসলামপুর, টাঙ্গাইল জেলা, নরসিংদী জেলা, জোমারবাড়ী, ধাঘহাটা ও কুড়িগ্রাম/চান্দঁইকোনা, পাবনা, নাটোর, নওগাঁ,রংপুর, নীলফামারী ও ডুমার। </td>
											</tr>
											<tr>
												<td>SD</td>
												<td>SD এর আওতায় প্রযোজ্য মোকাম সমুহের নামঃ রাজবাড়ী জেলা এবং রাজবাড়ী জেলা সংলগ্ন খানখানাপুর, পাংশা, খলিলপুর, খোকশা ও কুমারখালী, কানাইপুর, মধুখালী, কাদেরদী, জয়নগর, বোয়ালমারী, সাতর, মাদারীপুর। </td>
											</tr>
											<tr>
												<td>Knaf</td>
												<td>Knaf এর আওতায় প্রযোজ্য মোকাম সমুহের নামঃ Knaf</td>
											</tr>
											<tr>
												<td>White</td>
												<td>White এর আওতায় প্রযোজ্য মোকাম সমুহের নামঃ White</td>
											</tr>
										</tbody>
									</table>
								</div>
