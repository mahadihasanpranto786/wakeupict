                 ...
                 <div class="col-md-12">
                     ...
                     <div class="card card-default mt-3">
                         <div class="card-header">
                             ...
                             <h4 class="text-center text-uppercase"><u>Client Payment</u></h4>
                             <br>
                             <div class="row">
                                 <div class="col-sm-4 col-md-4 bg-secondary py-4">
                                     <h4 class="text-center">Total Payable Amount: <?= number_format(($clientById->c_payable), 2, '.', ',') ?></h4>
                                 </div>
                                 <div class="col-sm-4 col-md-4 bg-teal py-4">
                                     <h4 class="text-center">Total Paid Amount: <?= number_format(($clientById->c_paid), 2, '.', ',') ?></h4>
                                 </div>
                                 <div class="col-sm-4 col-md-4 bg-danger py-4">
                         ...
                         <form role="form" action="" method="post">
                             <div class="card-body">
                                 <div class="row mb-2 text-danger">
                                     <div class="col-sm-6">
                                         <h4 class="font-weight-bold">Client Name: <?= $clientById->c_title ?> </h4>
                                     </div>
                                     <div class="col-sm-6">
                                             ...
                                             <?php if (!empty($cPayments)) {
                                                    foreach ($cPayments->result() as $cPayment) { ?>
                                                     <tr>
                                                         ...
                                                         <td class="align-middle"><?= $cPayment->cp_reference ?></td>
                                                         <td class="align-middle"><?= $cPayment->cp_paid_by ?></td>
                                                         <td class="align-middle"><?= $cPayment->cp_cheque_no ?></td>
                                                         <td class="align-middle"><?= $cPayment->cp_note ?></td>
                                                         <td class="align-middle">
                                                             <a id="<?= $cPayment->cp_id; ?>" client_id="<?= $clientById->c_id; ?>" reference="<?= $cPayment->cp_reference; ?>" amount="<?= $cPayment->cp_amount; ?>" c_date="<?= date("d-m-Y", strtotime($cPayment->cp_date)); ?>" paid_by="<?= $cPayment->cp_paid_by; ?>" cheque_no="<?= $cPayment->cp_cheque_no; ?>" note="<?= $cPayment->cp_note; ?>" class='editbutton btn bg-warning btn-xs' data-toggle="modal">
             ...
             <div class="modal-body">
                 ...
                 <form role="form" action="<?php echo base_url('update_client_payment') ?>" method="post">
                     <div class="card-body">
                         ...
                         <input type="hidden" name="cp_c_id" value="" id="client_id">
