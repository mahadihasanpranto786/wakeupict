				...
				<div class="col-12">
					<div class="card card-info mt-3">
						<div class="card-header">
							<h3 class="card-title"><i class="fa fa-th"></i> List New Jute Purchase Invoice</h3>
							<?php
												...
												<td class="text-right align-middle">
													<div class="btn-group py-0 btn-group-sm">
														...
														if ($purchaseInvoiceApproveInfoByUser) {
															$serialApprove = (int)$list->jpis_user_serially_approval_status;
															$serialMax = (int)$purchaseInvoiceApproveInfoByUser->iajp_approval_status - 1;
															if ($serialMax == $serialApprove) {	?>

																<a href="<?php echo base_url(); ?>jute/Entry/viewPurchaseInvoice?jpis_id=<?= $list->jpis_id ?>"><button class="btn btn-warning btn-sm m-1" type="button" data-placement="top" title="View"><i class="fas fa-eye"></i> Approve Bill Book</button></a>
