...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6">
                    <h1>List Assorted Cut Deduction Summary</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active"><a
                                href="<?php echo base_url('add_assorted_cut_deduction'); ?>">Add New Assorted Cut
                                Deduction</a></li>
                        <li class="breadcrumb-item active">List Assorted Cut Deduction Summary</li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <div class="col-12">
                    ...
                    <div class="card card-info mt-3">
                        <div class="card-header">
                            ...
                            <a href="<?php echo base_url('add_assorted_cut_deduction'); ?>"><button
                                    class="btn btn-info float-right border"><i class="fas fa-plus-circle"></i> Add New
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-left py-0 align-middle">
                                            <div class="btn-group btn-group-sm">
                                                <a href="<?php echo base_url(''); ?>jute/Khamal/deleteAssortedCutDeduction?kh_ac_d_s_id=<?= $summary->kh_ac_d_s_id ?>"
                                                    class="deleteBySweetAlert">
                                                    <button class="btn btn-danger btn-sm mr-1" type="button"
                                                        data-placement="top" title="Delete">
                                                        <i class="fa fa-trash"></i> Delete</button>
                                                </a>
                                                <a
                                                    href="<?php echo base_url(''); ?>jute/Khamal/editAssortedCutDeduction?kh_ac_d_s_id=<?= $summary->kh_ac_d_s_id ?>"><button
