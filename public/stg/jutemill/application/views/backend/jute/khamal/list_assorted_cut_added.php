...
<div class="content-wrapper">
	...
	<section class="content-header">
		<div class="container-fluid">
			<div class="row">
				<div class="col-sm-6">
					<h1>List Assorted Cut Added Summary</h1>
				</div>
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						...
						<li class="breadcrumb-item active"><a href="<?php echo base_url('add_assorted_cut_added'); ?>">Add New Assorted Cut Added</a></li>
						<li class="breadcrumb-item active">List Assorted Cut Added Summary</li>
					</ol>
				</div>
			</div>
		</div>
