		...
		<nav class="mt-2">
			<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
				...
				<li class="nav-item has-treeview <?= active_open('dashboard', $main_nav); ?>">
					<a href="<?php echo base_url('operator') ?>" class="nav-link <?= active_nav('dashboard', $main_nav); ?>">
						...
						?>
								<li class="nav-item">
									<a href="<?php echo base_url('list_processing_purchase') ?>" class="nav-link <?= active_nav('list_processing_purchase', $sub_nav); ?>">
										...
										<p>Processing</p>
										<?php
										if ($purchaseInvoiceApproveInfoByUser->iajp_approval_status == $userId) { ?>
				...
				<li class="nav-item has-treeview <?= active_open('daily_issue', $main_nav); ?>">
					...
					<ul class="nav nav-treeview">
						...
						<li class="nav-item">
							<a href="<?php echo base_url('list_add_new_daily_issue') ?>" class="nav-link <?= active_nav('list_add_new_daily_issue', $sub_nav); ?>">
								<i class="far fa-circle nav-icon"></i>
								<p>Add Daily Issue</p>
							</a>
						</li>
