...
class Security_operator extends CI_Controller
{

	private $main_layout = 'backend/master_layout';
	private $side_menu = 'backend/authority/security_operator/side_menu';
	private $viewPath = 'backend/authority/security_operator/';
