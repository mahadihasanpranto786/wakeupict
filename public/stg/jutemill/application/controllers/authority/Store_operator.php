...
class Store_operator extends CI_Controller
{

	private $main_layout = 'backend/master_layout';
	private $side_menu = 'backend/authority/store_operator/side_menu';
	private $viewPath = 'backend/authority/store_operator/';
