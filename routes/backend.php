...
// our national work
Route::get('/national-work',  'backend\theme\clasic\home\HomeController@indexNationalWork')->name('national-work');
Route::get('/add-national-work',  'backend\theme\clasic\home\HomeController@addNationalWork')->name('add-national-work');
Route::post('/store-national-work', 'backend\theme\clasic\home\HomeController@storeNationalWork')->name('store-national-work');
Route::post('/update-national-work', 'backend\theme\clasic\home\HomeController@updateNationalWork')->name('update-national-work');
Route::get('/edit-national-work/{national_id}',  'backend\theme\clasic\home\HomeController@editNationalWork');
Route::get('/national-work-inactive/{national_id}',  'backend\theme\clasic\home\HomeController@nationalWorkInactive');
Route::get('/national-work-active/{national_id}',  'backend\theme\clasic\home\HomeController@nationalWorkActive');
Route::get('/delete-national-work/{national_id}',  'backend\theme\clasic\home\HomeController@nationalWorkDelete');

// our national work header
Route::post('/national-work-header-update', 'backend\theme\clasic\home\HomeController@nationalWorkHeaderUpdate')->name('national-work-header-update');
...
Route::get('/category-report', 'backend\theme\clasic\accounts\AccountController@categoryReport')->name('category-report');
...
// ================================================== payroll start =========================================================//
$hello = 'backend\theme\clasic\payroll\PayrollController';
...
Route::post('/generate-payroll-status-ajax', 'backend\theme\clasic\payroll\PayrollController@generatePayrollStatusAjax');

Route::get('/generate-payroll', 'backend\theme\clasic\payroll\PayrollController@generatePayroll')->name('generate-payroll');
Route::get('/generate-payslip', 'backend\theme\clasic\payroll\PayrollController@generatePayslip');
Route::post('/store-generate-payroll', 'backend\theme\clasic\payroll\PayrollController@storeGeneratePayroll')->name('store-generate-payroll');
