...
CREATE TABLE `blogs` (
  ...
  `creator_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `image_alt` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `active_blog` int NOT NULL DEFAULT '0',
  `status` int NOT NULL DEFAULT '1',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
(30, 'MatthewKeeds', 'm.evremov@enersets.com', 'Intp', NULL, '$2y$10$RwdEMDOQogsgmMeO.2nmu.8zFjd1ekVFbyClRMQfUD6yE6k3ZE.ne', NULL, '2021-10-01 14:48:42', '2021-10-01 14:48:42'),
(31, 'Harveykib', 'oshowitczjeremy@gmail.com', '1114', NULL, '$2y$10$979x4yO8RhGaGsQJc4XRPuP8KgufUMHfA327H/Qxx2x6rs7LUQY1W', NULL, '2021-10-01 15:02:48', '2021-10-01 15:02:48'),
(32, 'napilim.pro', 'aleksandr4w0bo@mail.ru', 'ISTP', NULL, '$2y$10$JBsvXTuhFjPncSZFibxB5u9a6Kx.v2..TQLtKHkK0SJBayYiJWjre', NULL, '2021-10-02 03:55:54', '2021-10-02 03:55:54');
