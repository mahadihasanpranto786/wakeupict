                    ...
                    <div>
                        <div class="card">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-6">
                                    <p><strong>Employee Name: {{ $payroll->user->name }}</strong> </p>
                                    <p><strong>Designation:
                                            {{ App\model\Designation::findOrFail($payroll->user->designation_id)->designation_name }}</strong>
                                    </p>
                                    <p><strong>Email: {{ $payroll->user->email }}</strong> </p>
                                </div>
                            </div>
                            <div>
                                <strong>Payroll Slip: {{ 1000 + $payroll->id }}</strong>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="center" style="width: 40%">{!! $payroll->remark !!}
                                                </td>
                                                <td class="right">{{ $payroll->amount }} TK</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                                        ...
                                        <table class="table center">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="right">
                                                        <strong>{{ $payroll->amount }} TK</strong>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                                ...
                                <footer class="footer">
                                    <div class="row ">
                                        <div class="col-xs-3 text-center">
                                            ...
                                            <p class="lead marginbottom">Employee Singnature</p>
                                        </div>
