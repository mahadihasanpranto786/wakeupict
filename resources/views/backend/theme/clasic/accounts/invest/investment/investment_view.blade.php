                    ...
                    <div>
                        <div class="card">
                            <div class="card-header">
                                ...
                                <p><strong>Date:</strong> {{ Carbon\Carbon::parse($invest->date)->format('d M, Y') }}
                                </p>
                            </div>
                            <div>
                                <strong>Investment Slip: {{ 1000 + $invest->id }}</strong>
                            </div>
                            <div class="card-body">
                                ...
                                <div class="table-responsive-sm">
                                    <table class="table table-striped table-bordered">
                                        <thead>
                                            <tr>
                                                <th class="left">Investor Name</th>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="left">{{ $invest->investor->name }}</td>
                                                <td class="center">{!! $invest->remark !!}</td>
                                                <td class="right">{{ $invest->amount }} TK</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                                        ...
                                        <table class="table center">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="right">
                                                        <strong>{{ $invest->amount }} TK</strong>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
