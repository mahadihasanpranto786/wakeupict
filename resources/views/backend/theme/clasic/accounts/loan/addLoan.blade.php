                    ...
                    <div class="col-md-6 offset-3">
                        <div class="card-body">
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 id="update_head" class="card-title text-center"> Add Loan</h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form action="{{ route('insertAndUpdateLoan') }}" method="POST"
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            @if (user(Auth::id()) == 1)
                                                <input type="hidden" name="loan_type" id="loan_type" value="Local">
                                            @elseif (user(Auth::id()) == 2)
                                                <input type="hidden" name="loan_type" id="loan_type" value="Global">
                                            @else
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="loan_holder_name" id="loan_holder_name"
                                                ...
                                                value="{{ old('loan_holder_name') }}" data-validation='required'>
