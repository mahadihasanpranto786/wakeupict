...
<head>
    ...
    <title>Multiple Expense Print</title>
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <p><strong>Date:</strong>
                                    {{ Carbon\Carbon::parse($multipleExpense->date)->format('d M, Y') }}
                                </p>
                            </div>
                            <div>
                                <strong>Multiple Expense Slip: {{ 1000 + $multipleExpense->id }}</strong>
                            </div>
                            <div>
                                <strong>{{ $expensesType }} Expense</strong>
                            </div>
                            <div class="card-body">
                                        ...
                                        <table class="table center table-bordered">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="right">{{ $expenseAmountTotal }} TK</td>
                                                </tr>
                                                @php
                                                    $totalPayback = 0;
                                                @endphp
                                                @foreach ($expenses as $expense)
                                                    ...
                                                    @php
                                                        $expensePayback = App\model\ExpensePayback::where('expense_id', $expense->id)
                                                            ->where('status', 1)
                                                            ->sum('payback_money');
                                                        $totalPayback += $expensePayback;
                                                    @endphp
                                                    <tr>
                                                        @if (!empty($expensePayback))
                                                            <td class="center">
                                                                <strong>Payback
                                                                    ({{ $expense->category->title }}):</strong>
                                                            </td>
                                                            <td class="right">({{ $expensePayback }}) TK
                                                            </td>
                                                        @else
                                                        @endif
                                                    </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="right">
                                                        <strong>
                                                            {{ $expenseAmountTotal - $totalPayback }}TK</strong>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
