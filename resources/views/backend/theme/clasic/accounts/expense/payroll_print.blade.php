                    ...
                    <div>
                        <div class="card">
                            <div class="card-header">
                                ...
                                <p><strong>Date:</strong> {{ Carbon\Carbon::parse($payroll->date)->format('d M, Y') }}
                                </p>
                            </div>
                            <div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive-sm">
                                    <table class="table table-striped table-bordered">
                                        <thead>
                                            <tr>
                                                <th class="left" style="width: 20%">Category</th>
                                                <th class="left" style="width: 20%">Employee Name</th>
                                                <th class="center" style="width: 18%">Salary Month</th>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="left">
                                                    {{ $expense->category->title }}</td>
                                                <td class="left">
                                                    {{ $payroll->user->name }}</td>
                                                <td class="left">
                                                    {{ Carbon\Carbon::parse($payroll->salary_month)->format('F, Y') }}
                                                </td>
                                                <td class="center">{!! $payroll->remark !!}
                                                </td>
                                                <td class="right">{{ $payroll->amount }}
                                                    TK</td>
                                            </tr>
                                        </tbody>
                                    </table>
