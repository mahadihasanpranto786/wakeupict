                    ...
                    <div>
                        <div class="card">
                            <div class="card-header">
                                ...
                                <p><strong>Date:</strong> {{ Carbon\Carbon::parse($income->date)->format('d M, Y') }}
                                </p>
                            </div>
                            <div>
                                <strong>Income Slip: {{ 1000 + $income->id }}</strong>
                            </div>
                            <div>
                                <strong>{{ $income->category->type }} Income </strong>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table class="table table-striped table-bordered">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="center" style="width: 20%">Income Title</th>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="left">{{ $income->category->title }}</td>
                                                <td class="center">{{ $income->title }}</td>
                                                <td class="center">{!! $income->remark !!}</td>
                                        ...
                                        <table class="table  center">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="right">
                                                        <strong>{{ $income->amount }} TK</strong>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
