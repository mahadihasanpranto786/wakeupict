...
@section('add_income_active', 'active')
{{-- menu active end --}}
                        ...
                        <div class="card-body">
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 id="update_head" class="card-title text-center"> Insert Income</h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form action="{{ route('store-income') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="card-body">
