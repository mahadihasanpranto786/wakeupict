...
@section('maincontant')
                            ...
                            <div class="my-2">
                                @if (checkUserType() == 0)
                                    <button type="button" class="btn btn-primary" data-toggle="modal"
                                        ...
                                        <i class="fas fa-plus-circle"></i>Add Tranning Page Banner
                                    </button>
                                @endif
                            </div>
                            <table class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($banners as $banner)
                                                    ...
                                                    <div class="d-flex">
                                                        ...
                                                        @if ($banner->active_status == 1)
                                                            <a title="Inactive"
                                                                ...
                                                                href="{{ url('training-banner-inactive/' . $banner->id) }}">
                                                                <i class="fas fa-arrow-circle-down text-white"></i>
                                                            </a>
                                                        @else
                                                            <a title="Active"
                                                                class="flex items-center btn btn-success btn-sm"
                                                                href="{{ url('training-banner-active/' . $banner->id) }}">
                                        ...
                                        <div class="modal fade" id="editBannerCourse{{ $banner->id }}" tabindex="-1"
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="card card-primary">
                                                            <!-- form start -->
                                                            <div class="card">
                                                                <form action="{{ route('tranning_banner_update') }}"
    ...
    <div class="modal fade" id="createBanner" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header  bg-success">
                    <h5 class="modal-title" id="exampleModalLabel">Insert Tranning Page Banner</h5>
                ...
                <div class="modal-body">
                    <div class="card card-primary">
                        <!-- form start -->
                        <div class="card">
                            <form action="{{ route('tranning_banner_store') }}" method="POST"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea type="text" name="banner_description" class="form-control textarea"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="body_title" data-validation='required'
